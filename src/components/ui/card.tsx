...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // 20px gutter, not the vendored 16px: at 16 the dashboard's numbers and
        // the applications table sat almost against the card edge. `sm` cards
        // keep the tighter value for genuinely dense slots.
